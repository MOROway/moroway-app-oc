//NOTIFICATIONS
function notify (a, b, c, d, e, f, g){
	if(g == undefined) {
		g = true;
	}
	var notificationContainer = document.querySelector('#canvas-notifier');
	if(g || (notificationContainer.MaterialSnackbar.queuedNotifications_.length == 0 && !notificationContainer.MaterialSnackbar.active)) {
...
function removeSavedGame() {
	if(window.localStorage.getItem("morowayAppSavedWithVersion") !== null){
...
const STRINGS = {
	...
	de:{
		...
		settingsScreenOptNotificationsTitle: "Benachrichtigungen", settingsScreenOptNotificationsDesc: "Zeigt Texteinblendungen bei verschiedenen Aktionen an.", settingsScreenOptNotificationsInfo: "Funktioniert nicht auf kleinen Bildschirmen. Einige Benachrichtigungen werden trotz Deaktivierung dieser Option angezeigt.",settingsScreenOptClassicUITitle: "Klassische Steuerelemente", settingsScreenOptClassicUIDesc: "Zeigt die klassischen Steuerelemente wie Trafo und Zugauswahlbutton.", settingsScreenOptSelectedTrainTitle: "Ausgewählter Zug", settingsScreenOptSelectedTrainDesc: "Zeigt den Namen des ausgewählten Zuges immer an.", settingsScreenOptSelectedTrainInfo: "Erfodert aktivierte \"Klassische Steuerelemente\".", settingsScreenOptCursorTitle: "Cursor als Farbe darstellen", settingsScreenOptCursorDesc: "Zeigt statt dem Maussymbol einen Farbkreis.", settingsScreenOptCursorInfo: "Funktioniert nicht auf Touchscreens.", settingsScreenOptTaxOfficeTitle: "Brennendes Finanzamt animieren", settingsScreenOptTaxOfficeDesc: "Zeigt Animationen zum brennenden Finanzamt.", settingsScreenOptSaveGameTitle: "Spiel speichern", settingsScreenOptSaveGameDesc: "Speichert den Zustand des jeweils aktuellen Spieles für das nächste Spiel.", settingsScreenOptSaveGameInfo: "Wird im Mehrspieler-Modus ignoriert.", settingsScreenOptSaveGameButtonDelete: "Gespeichertes Spiel jetzt löschen", settingsScreenApply: "Einstellungen aktualisiert", settingsScreenLangSelectInfo: "Sprache wählen (erfordert Neuladen)", settingsScreenLangSelectChange: "Sprachwahl gespeichert - Erneut laden, um anzuwenden", settingsScreenLangSelectChangeButton: "Neuladen",
