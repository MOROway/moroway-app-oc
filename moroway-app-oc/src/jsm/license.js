        ...
        fetch(file, { redirect: "error" })
            ...
            if (text) {
                ...
                for (var i = 0; i < textArray.length; i++) {
                    ...
                    if (i == 0) {
                        elementTitle === null || elementTitle === void 0 ? void 0 : elementTitle.appendChild(element2Add);
                    }
                    else {
                        elementContent === null || elementContent === void 0 ? void 0 : elementContent.appendChild(element2Add);
                    }
                }
            }
            else {
