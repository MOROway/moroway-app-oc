...
function changeCOSection(cO,isFront, input1, i,reverse){
    ...
    if((trains[input1].standardDirection && !reverse) || (!trains[input1].standardDirection && reverse)){ // Switch sections
...
function setCOPosCorr(cO,isFront, input1, currentObject,i) { // Fix car position and angle relative to locomotive
